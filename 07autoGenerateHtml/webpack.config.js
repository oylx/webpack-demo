...
module.exports = {
  ...
  output: {
    ...
    // publicPath: __dirname + '/dist/', // js 打包成了绝对路径,不行的,/Users/mi/Documents/....../dist/static/js/page.bundle.js
    path: path.resolve(__dirname, 'dist'), // 打包文件的输出目录
    filename: 'static/js/[name].bundle.js', // 代码打包后的文件名
    chunkFilename: 'static/js/[name].js' // 代码拆分后的文件名
  },
  plugins: [
